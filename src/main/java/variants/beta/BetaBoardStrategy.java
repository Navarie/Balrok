...
public class BetaBoardStrategy implements BoardLayoutStrategy {
    ...
    private void initialiseUnitFormation() {
        setUnitAt(new Position(1, 1), new UnitImpl(WHITE_PLAYER, NEUTRAL, DWARF, NAWOORI));
        setUnitAt(new Position(6, 7), new UnitImpl(WHITE_PLAYER, NEUTRAL, ELF, NAWOORI));
        setUnitAt(new Position(4, 7), new UnitImpl(BLACK_PLAYER, NEUTRAL, ELF, NAWOORI));
        setUnitAt(new Position(4, 1), new UnitImpl(BLACK_PLAYER, NEUTRAL, ELF, NAWOORI));
        setUnitAt(new Position(3, 6), new UnitImpl(WHITE_PLAYER, NEUTRAL, DWARF, NAWOORI));
        setUnitAt(new Position(3, 7), new UnitImpl(WHITE_PLAYER, NEUTRAL, GNOME, NAWOORI));
        setUnitAt(new Position(6, 6), new UnitImpl(BLACK_PLAYER, MONSTER, PRIMORDIAL_DRAGON, NAWOORI));
        setUnitAt(new Position(5, 5), new UnitImpl(BLACK_PLAYER, NEUTRAL, HUMAN, NAWOORI));
        setUnitAt(new Position(5, 3), new UnitImpl(BLACK_PLAYER, NEUTRAL, SIREN, NAWOORI));
        setUnitAt(new Position(2, 2), new UnitImpl(WHITE_PLAYER, NEUTRAL, HUMAN, NAWOORI));
    }
    ...
    private void initialiseBoard() {
        ...
        fieldTypes = BoardUtility.createInitialBoard(boardLayout, "BETA");
    }
}
